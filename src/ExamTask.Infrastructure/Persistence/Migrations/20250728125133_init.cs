        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamGroupId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentExamId = table.Column<long>(type: "bigint", nullable: false),
                    FirstAnswerOption = table.Column<int>(type: "int", nullable: true),
                    FirstAnsweredAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastAnswerOption = table.Column<int>(type: "int", nullable: true),
                    LastAnsweredAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ChangeCount = table.Column<int>(type: "int", nullable: false),
                    IsOutsideAllowedTime = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
